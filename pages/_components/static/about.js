    ...
    <React.Fragment>
      ...
      <div className="max-w-screen-lg m-auto relative z-10 -mt-40 text-repeat-black text-lg">
        <div className="container subpages lg:w-3/4 bg-white rounded-tr-2xl border-t-4 border-repeat">
          ...
          <p className="font-utopia pt-6 md:w-4/5 text-repeat-burnt">The REPEAT Project provides regular, timely, and independent environmental and economic evaluation of federal energy and climate policies as they’re proposed and enacted.</p>
