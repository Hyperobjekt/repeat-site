      ...
      {({ open }) => (
        <>
          <div className="container max-w-screen-lg mx-auto pt-4 md:px-1 sm:px-6">
            <div id="nav-bar" className="flex justify-between items-center tracking-wide md:pt-6 pb-4 md:justify-start md:space-x-10 transition-all duration-200 ease-in-out">
